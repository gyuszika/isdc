	...
	<form:form action="person.do" method="POST" commandName="person">
		<table>
			...
			<tr>
				...
				<td><form:input path="performance_yr1" /></td>
			</tr>
			<tr>
				<td>Performance Yr2</td>
				<td><form:input path="performance_yr2" /></td>
			</tr>
			<tr>
				<td>Performance Yr3</td>
				<td><form:input path="performance_yr3" /></td>
			</tr>
			...
			<table border="1">
				...
				<c:forEach items="${personList}" var="person">
					<tr>
						...
						<td>${person.isin}</td>
						<td>${person.name}</td>
						<td>${person.performance_yr1}</td>
						<td>${person.performance_yr2}</td>
						<td>${person.performance_yr3}</td>
					</tr>
				</c:forEach>
			</table>
</body>
